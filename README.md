...
- **Tesla**：分析期間を通じて収益・株価ともに力強く持続的な成長を示しており、特に2020年以降は株価の上昇が加速。市場がTeslaの事業拡大という基礎的な要因を織り込んでいったことがわかります。
- **GameStop**：2021年頃に株価が急騰した一方（いわゆる「ミームストック」現象として広く知られる出来事）、同時期の収益は横ばい〜減少傾向。株価の値動きが事業の実態から**差異**した典型的な事例です。

この比較で明らかになったこと：**株価と収益は必ずしも連動しない**ということが、両方のグラフで可視化することで一目で分かります。
...
*このプロジェクトは、Pythonの基礎、データ構造、Webスクレイピング、および金融データ分析のためのデータ加工に焦点を当てたハンズオン形式の学習課題として作成しました。*
